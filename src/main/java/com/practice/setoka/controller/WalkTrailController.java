...
public class WalkTrailController {
	...
	WalkTrailController(BoardController boardController, Upload upload) {
...
//	return "redirect:/AdoptDetail/" + num;
	...
	public String walkTrailLikeComment(@AuthenticationPrincipal CustomUserDetails authUser, @PathVariable("num") int boardNum,
		...
		return "redirect:/WalkTrailDetail/" + boardNum + "#comment-" + commentNum; // redirect되도 좋아요 누를때 그자리에 있게해줌
	}
}
