...
//	}
	...
	public String adoptMain(Model model, @RequestParam(value = "keyword", required = false) String keyword,
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	// 산책로 메인페이지
		...
		public String walkTrailReportBoard(@PathVariable("num") int num, @AuthenticationPrincipal CustomUserDetails authUser) {
	...
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		// 중고장터 메인페이지
				...
				public String usedGoodsReportBoard(@PathVariable("num") int num, @AuthenticationPrincipal CustomUserDetails authUser) {
