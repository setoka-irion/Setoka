...
build {
    ...
    provisioner "shell" {
        inline = [
            ...
            "echo 'StandardOutput=append:/home/ubuntu/irion/app.log' | sudo tee -a /etc/systemd/system/IRI-on.service",
            "echo 'StandardError=append:/home/ubuntu/irion/app.log' | sudo tee -a /etc/systemd/system/IRI-on.service",
